...
| `DEFAULT_DIR`     | no          | primera raíz             | "Home" del panel: dónde nacen las sesiones tmux nuevas y qué usan los endpoints sin `?session=`. Debe estar dentro de alguna raíz del perímetro |
