...
- `test/ui-test.mjs` — smoke de UI en Chromium headless, viewport iPhone (**30 checks**, todos PASS; deja `test/shot-*.png`. Los 5 de la sección 5c —switchers de modo/modelo— son de la 4ª sesión; ver `TASKS.md` para el backlog de features y lo ya hecho.)
